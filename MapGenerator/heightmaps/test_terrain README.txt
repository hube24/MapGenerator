...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=test_terrain&box=19.873770,50.173494,19.761562,50.101629
...
-----------
  ...
  * test_terrain Height Map (ASTER 30m).png
  ...
  * test_terrain Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * test_terrain Height Map (SRTM3 v4.1).png
  ...
  * test_terrain Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 205m (actual) is equal to 40m in
