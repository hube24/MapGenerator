...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=test_area&box=19.888991,50.162217,19.748765,50.072385
...
-----------
  ...
  * test_area Height Map (ASTER 30m).png
  ...
  * test_area Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * test_area Height Map (SRTM3 v4.1).png
  ...
  * test_area Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 178m (actual) is equal to 40m in
